...
Route::get('/bespoke', fn (StorefrontController $controller) => $controller->simple('bespoke'))->name('bespoke');
Route::get('/appointments', fn (StorefrontController $controller) => $controller->simple('appointments'))->name('appointments');
Route::get('/boutique', fn (StorefrontController $controller) => $controller->simple('boutique'))->name('boutique');
Route::get('/market', fn (StorefrontController $controller) => $controller->simple('market'))->name('market');
Route::prefix('policies')->name('policies.')->group(function () {
    Route::get('/shipping', fn (StorefrontController $controller) => $controller->policy('shipping'))->name('shipping');
    Route::get('/returns', fn (StorefrontController $controller) => $controller->policy('returns'))->name('returns');
    Route::get('/faq', fn (StorefrontController $controller) => $controller->policy('faq'))->name('faq');
});
Route::redirect('/home', '/');
